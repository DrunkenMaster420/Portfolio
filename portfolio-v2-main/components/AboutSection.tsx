...
const AboutSection: React.FC<AboutSectionProps> = () => {
  ...
  const aboutParagraphs = [
    "I hold a Bachelor of Technology (B.Tech) in Computer Science and Engineering from JIS College of Engineering, Kolkata, graduating with an 8.74/10.0 CGPA in 2024. My academic journey provided me with a strong foundation in algorithms, data structures, software architecture, and the principles of modern engineering, nurturing a passion for continuous learning and innovative problem-solving.My expertise centers on full-stack development and automation, with hands-on experience in designing and delivering scalable, end-to-end solutions. I work proficiently with technologies such as Spring Boot, C#, .NET, React, Angular, SQL, and Selenium, contributing to robust web applications and enterprise-grade platforms. As a Software Engineer at LTIMindtree, I develop and maintain responsive systems and streamline quality assurance processes through automation.Beyond my professional role, I am deeply interested in user - centric solution design and leveraging code for real - world impact.I thrive on turning complex challenges into intuitive digital products and value clear communication, teamwork, and a dedication to delivering measurable results.My curiosity and drive for excellence continue to shape my growth as a developer and as a creative problem - solver.",
  ];
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <span
                      ...
                      style={{ color: modernColors.text }}
                    >
                      Freelancer at Fiverr,Guru ,Custom Clients
                    </span>
                  </div>
                  <div className="flex justify-between items-start">
                    <span
